...
const homeServiceImages: Record<string, string> = {
  ...
  "deck-construction": "/images/site/home-service-deck-fence-mcaze.webp",
  "fence-installation": "/images/site/home-service-deck-fence-mcaze.webp",
  ...
  return (
    <>
      <Hero
        ...
        title="Renovation and Construction Services in the GTA"
