...
export default async function CityPage({ params }: CityPageProps) {
  ...
  return (
    <>
      <Hero eyebrow="Service Area" title={`Renovation Company in ${city.name}`} copy={city.intro} image="/placeholders/renovation-5.svg" primaryCta={{ label: "Request a Quote", href: "/contact" }} />
      <Section>
